...
public class AdminCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        redbull = (ImageView) findViewById(R.id.redbull);
        banana = (ImageView) findViewById(R.id.banana);
        apple = (ImageView) findViewById(R.id.apple);
        graps = (ImageView) findViewById(R.id.graps);

        bottle = (ImageView) findViewById(R.id.bottle);
        millk = (ImageView) findViewById(R.id.millk);
        ...
        redbull.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                intent.putExtra("category", "redbull");
                startActivity(intent);
            }
        });
